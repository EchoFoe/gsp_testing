...
class Promotion(models.Model):
    ...
    country = models.CharField(blank=True, null=True, default=None, max_length=200, verbose_name='Страна')
    region = models.CharField(blank=True, null=True, default=None, max_length=200, verbose_name='Регион')
    town = models.CharField(blank=True, null=True, default=None, max_length=200, verbose_name='Город')
    ...
    schedule_start = models.TimeField(blank=True, null=True, verbose_name='Начало рабочего дня (начало)')
    schedule_end = models.TimeField(blank=True, null=True, verbose_name='Конец рабочего дня (конец)')
    created = models.DateField(blank=True, null=True, default=timezone.now, verbose_name='Дата создания записи')
    updated = models.DateField(blank=True, null=True, default=timezone.now, verbose_name='Дата ред-ия записи')
